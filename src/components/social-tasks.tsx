...
const tasksList = [
  { id: 1, name: 'Join Telegram', icon: <TelegramIcon />, reward: 50, link: '#' },
  { id: 2, name: 'Follow on X', icon: <XIcon />, reward: 50, link: '#' },
  { id: 3, name: 'Retweet Post', icon: <XIcon />, reward: 50, link: '#' },
  { id: 4, name: 'Join Discord', icon: <DiscordIcon />, reward: 50, link: '#' },
];
...
export function SocialTasks() {
  ...
  const handleCompleteTask = async (id: number, reward: number, link: string) => {
    try {
        // In a real app, you would open the link and have a backend verification.
        // For now, we optimistically complete it.
  ...
  const isTaskCompleted = (id: number) => {
